<template>
    <div class="wrapper">
        <div class="cols">
            <div v-for="movie in movies" v-bind:key="movie.id" class="col" ontouchstart="this.classList.toggle('hover');">
                <div class="container">
                    <div class="front" v-bind:style="{backgroundImage:'url(' + movie.images.large + ')'}">
                        <div class="inner">
