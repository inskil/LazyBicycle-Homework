<template>
    <div class="wrapper">
        <div class="cols">
            <div v-for="book in books" v-bind:key="book.id" class="col" ontouchstart="this.classList.toggle('hover');">
                <div class="container">
                    <div class="front" v-bind:style="{backgroundImage:'url(' + book.images.large + ')'}">
                        <div class="inner">
                            <p>{{book.author}}</p>
