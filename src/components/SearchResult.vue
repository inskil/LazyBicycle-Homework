<template>
    <div>
        <div class="search d6">
            <form>
                <input v-model="key" type="text" placeholder="搜索你感兴趣的书籍、影视和小组..." @on-enter="getlist">
                <button type="submit"></button>
            </form>
        </div>
        <div>
            <Menu active-name="all" style="float: left; width: 15%">
                <MenuItem name="all" class="search-menu">
                    <Icon type="ios-paper"/>
                    全部
                </MenuItem>
                <MenuItem name="book" class="search-menu">
                    <Icon type="ios-book"/>
                    书籍
                </MenuItem>
                <MenuItem name="movie" class="search-menu">
                    <Icon type="ios-film"/>
                    影视
                </MenuItem>
                <MenuItem name="group" class="search-menu">
                    <Icon type="ios-people"/>
                    小组
                </MenuItem>
                <MenuItem name="discussion" class="search-menu">
                    <Icon type="ios-text"/>
                    讨论
                </MenuItem>
            </Menu>
            <table style="left: 20%; width:80%; position: absolute">
                <tr v-for="book in alllist.book" v-bind:key="book._id" style="padding: 1rem">
                    ...
                    <th>
                        <div class="pic_div material-card material-shadow-2 material-hover"><img class="pic"
                ...
                <tr v-for="book in alllist.topic" v-bind:key="book._id" style="padding: 1rem">
                    <th align="left" style="font-weight: normal; width: 60%; border-bottom: dashed 1px #5cadff">
                        ...
                        <div class="summary">{{book.text}}</div>
                    </th>
                </tr>
